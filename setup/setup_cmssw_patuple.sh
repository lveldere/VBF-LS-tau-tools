...
cp -v /afs/naf.desy.de/user/m/marconi/public/VBFPATupleProducer/hiMassTau_patProd.py $CMSSW_BASE/src/HighMassAnalysis/Configuration/test/Data_TauTauSkim/hiMassTau_patProd.py

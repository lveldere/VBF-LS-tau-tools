...
cp -v /afs/naf.desy.de/user/m/marconi/public/VBFPATupleProducer/hardcoded_hiMassTau_patProd.py $CMSSW_BASE/src/HighMassAnalysis/Configuration/test/Data_TauTauSkim/hiMassTau_patProd.py
cp -v /afs/naf.desy.de/user/m/marconi/public/VBFPATupleProducer/patTupleEventContentForHiMassTau_cff.py $CMSSW_BASE/src/HighMassAnalysis/Configuration/python/patTupleEventContentForHiMassTau_cff.py
